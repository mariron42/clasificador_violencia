...
La revisión 5 del póster añade citas enlazadas en los bloques de comparación, salidas, aumentación, router, anotación y resultados. Las referencias apuntan a una revisión fija del repositorio público y el QR abre su página principal. No modifica resultados ni afirmaciones científicas. El texto de instrucciones distingue requisitos confirmados de formato e interpretación no confirmada del idioma.
