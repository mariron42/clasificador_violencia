...
Fuente: docs/method.md; docs/results.md (corrected system-description paper).
...
Fuente: docs/method.md, model families and implementation.
...
Fuente: docs/results.md, classical/encoder and common 133-record comparisons.
...
Fuente: scripts/run_competitive_encoder_severity.py; scripts/run_subtask2_encoder_20260429.py; docs/method.md.
...
Fuente: src/womenhelp_competition/text_augmentation.py; results/evidence.json.
...
Fuente: results/evidence.json; docs/results.md. Delta = 100*(augmented - baseline).
...
Fuente: docs/annotation_consensus.md; results/annotation_consensus.json; scripts/analyze_annotations.py. New analysis after the paper.
...
Fuente: scripts/materialize_hailmary_s1_foldbag_router_20260507.py; docs/method.md.
...
Fuente: docs/results.md; corrected paper, official results. https://www.codabench.org/competitions/14614/
...
Fuente: docs/method.md, limitations and future validation.
